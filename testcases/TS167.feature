...
@Regression @TS167 @TuesThurs
Scenario Outline: TS167_Payment_with_Retry Failed
...
And Create payment_SubInstruction in the scheduled Instructions with given "TS167_1"
