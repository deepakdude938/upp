Feature: TS152_ProdIssue3

@DupTxnProdIssue @TS152 @Biweekly
Scenario Outline: ProdIssue3
...
And Create Payment_SubInstruction in the scheduled Instructions with given "<TSID>"
And Create Payment_SubInstruction in the scheduled Instructions with given "TS152_1"
And Submit the deal
