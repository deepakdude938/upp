...
Then Add Party basic_Details with given "TS46_1".
Then Add Party Accounts with given "TS46_1".
Then submit the deal
Then approve the deal from the deal checker common method
And Login to UPP through api
And Call the Rule_OBOPartyResponsibility_PartyId_DealRefId with given "<TSID>".
Examples:
      |TSID   |
      |TS46   |
