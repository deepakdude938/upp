...
public class Verify_User_Is_Deleted extends BaseClass {
	...
	public void verify_User_is_Deleted(String username) throws Exception {
		...
		applyExplicitWaitsUntilElementVisible(ou.user_deleted_message, Duration.ofSeconds(20));
		String deletedmessage = ou.user_deleted_message.getText();
		Assert.assertEquals(deletedmessage, "The user has been deleted");
