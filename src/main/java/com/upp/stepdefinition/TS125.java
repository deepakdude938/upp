...
public class TS125 extends BaseClass implements ICallback {
	DashBoard_Module dm;
	...
	public TS125(DashBoard_Module dm) {
	...
	@Given("Verify Deal refId and Participant Refid gets displayed with given {string}")
	public void verify_Deal_refId_and_Participant_Refid_gets_displayed_with_given(String string) throws Exception {
		ecommTxn.verifyDealRefIdAndParticipantRefId(string);
	}
