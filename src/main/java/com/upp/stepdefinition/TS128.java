...
public class TS128 extends BaseClass implements ICallback {
	DashBoard_Module dm;
	...
	public TS128(DashBoard_Module dm) {
	...
	@Given("Verify Name and Address line gets displayed with given {string}")
	public void verify_Name_and_Address_line_gets_displayed_with_given(String string) throws Exception {
		ecommTxn.verifyNameAndAddressLine(string);
	}
