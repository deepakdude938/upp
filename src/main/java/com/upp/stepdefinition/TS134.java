...
public class TS134 extends BaseClass implements ICallback {
	DashBoard_Module dm;
	...
	public TS134(DashBoard_Module dm) {
	...
	@Given("Verify ultimate debetor checkbox is disable with given {string}")
	public void verify_ultimate_debetor_checkbox_is_disable_with_given(String string) throws Exception {
		ecommTxn.verifyUltimateDebtorCheckboxDisable(string);
	}
