...
public class TS129 extends BaseClass implements ICallback {
	DashBoard_Module dm;
	...
	public TS129(DashBoard_Module dm) {
	...
	@Given("Verify Name and Address line, deal refid, participant ref id  gets displayed with given {string}")
	public void verify_Name_and_Address_line_deal_refid_participant_ref_id_gets_displayed_with_given(String string)
			throws Exception {
		ecommTxn.verifyNameAndAddressLineDealRefParticipantRef(string);
	}
