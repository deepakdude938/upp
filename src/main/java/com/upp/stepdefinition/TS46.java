...
public class TS46 extends BaseClass {
	DashBoard_Module dm;
	DealPage dp;
	...
	@And("Call the Rule_OBOPartyResponsibility_PartyId_DealRefId with given {string}.")
	public void call_the_Rule_OBOPartyResponsibility_PartyId_DealRefId_with_given(String string) throws Exception {
	    rule.Rule_OBOPartyResponsibility_PartyId_DealRefid(TS06.dealId, string);
	}
}
