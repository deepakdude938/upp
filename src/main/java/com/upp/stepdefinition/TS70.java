...
public class TS70 extends BaseClass {
	...
	@Then("Verify in Budget tab Utilized Budget Amount and Available Budget Amount")
	public void verify_in_Budget_tab_Utilized_Budget_Amount_and_Available_Budget_Amount() {
