...
import com.upp.UsersApi.Get_List_of_10Users_API;
...
public class TS95 extends BaseClass {
	DashBoard_Module dm;
	DealPage dp;
...
//	public static String dealId = "";
	...
	Get_List_of_10Users_API getUsers;

	public TS95() {

		this.dm = new DashBoard_Module();
		getUsers = new Get_List_of_10Users_API();
	}



	@Then("Call the Get_List_of_TenUsers API")
	public void call_the_Get_List_of_TenUsers_API() throws Exception {
