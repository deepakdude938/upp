...
public class TS47 extends BaseClass {
	DashBoard_Module dm;
	DealPage dp;
	...
	Rules_Creditor_Party_Validate creditor;
	...
	@Given("Run Rule_Creditor_Party_Validate using api with given {string}")
	public void run_Rule_Creditor_Party_Validate_using_api_with_given(String string) throws Exception {
		login_UPP.loginToUpp();
		creditor.Rule_Creditor_Party_Validate(string, TS06.dealId, TS06.sourceAccountNo);
	}
}
