...
public class TS33 extends BaseClass {
	DashBoard_Module dm;
	DealPage dp;
	...
	Rule_OBODetails_Null_OBO rule_null;
	...
	public TS33() {
		...
		rule_null=new Rule_OBODetails_Null_OBO();

	}
	
	@And("Call the Rule_OBODetails_Null_OBO with given {string}.")
	public void call_the_Rule_OBODetails_Null_OBO_with_given(String string) throws Exception {
		login_UPP.loginToUpp();
	    rule_null.Rule_Non_OBO_Api(TS06.dealId,string);
	}
