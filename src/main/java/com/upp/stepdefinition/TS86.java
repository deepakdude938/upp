...
public class TS86 extends BaseClass {
	DashBoard_Module dm;
	DealPage dp;
	...
	@Then("Call the Create User Api with given {string}")
	public void call_the_Create_User_Api(String string) throws Exception {
		login_UPP.loginToUpp();
		userName =user.createUsers(string,prop);
	}
	
	@Then("login with updated user using API")
	public void login_with_updated_user_using_API() throws Exception {
