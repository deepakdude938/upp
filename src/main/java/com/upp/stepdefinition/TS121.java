...
public class TS121 extends BaseClass implements ICallback {
	DashBoard_Module dm;
	...
	public TS121(DashBoard_Module dm) {
	...
	@Given("Add two ecomm accounts with given {string} and {string}")
	public void add_two_ecomm_accounts_with_given_and(String string, String string2) throws Exception {
		login.loginToUpp();
	...
	@Then("Edit the second account and select OBO Responsibility with given {string}.")
	public void edit_the_second_account_and_select_OBO_Responsibility_with_given(String string) throws Exception {
		 edit.EditOBOResponsibilty_In_2ndAccount(string);
	}

	@Then("Add deal in ecommerce transaction maker queue with ultimateDebtor {string}")
	public void add_deal_in_ecommerce_transaction_maker_queue_with_ultimateDebtor(String string) throws Exception {
		System.out.println(TS07.dealId);
		System.out.println(DealPage.sourceAccountNo);
		System.out.println(DealPage.toaccountNo);
//		System.out.println(TS07.dealId);
		ecommTxn.addDealAsEcommerceTxn1(TS07.dealId,string, DealPage.sourceAccountNo, DealPage.toaccountNo,this);
	}
