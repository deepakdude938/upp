...
public class Rule_Non_OBO_Virtual extends BaseClass {
	public static String response = "";
	public ExcelReader externalData;

	public void Rule_Non_OBO_Virtual_Api(String dealId,String TSID,String virtualaccount) throws Exception {
