...
public class Rule_ParticipantId_OBODetails extends BaseClass{
	...
	public static void Rule_ParticipantId_OBODetails_Api(String TSID,String dealId, String participant1)
			throws Exception {
		...
		Response res = given().header("Content-Type", "application/json")
				...
				.body(Payload.rule_ParticipantId_OBODetails(TSID,dealId, participant1)).when()
