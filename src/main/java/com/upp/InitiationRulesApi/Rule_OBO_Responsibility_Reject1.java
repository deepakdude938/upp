...
public class Rule_OBO_Responsibility_Reject1 extends BaseClass{
	public static String response = "";

	public static ExcelReader externalData;

	public static void Rule_OBO_Responsibility_reject1(String dealId, String TSID) throws Exception {
		...
		Response res = given().header("Content-Type", "application/json")
				.header("Authorization", LoginAPI_UPP.authToken).body(Payload.Rule_OBO_Responsibility_Reject1(dealId, TSID)).when()
