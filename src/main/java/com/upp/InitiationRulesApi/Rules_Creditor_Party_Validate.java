...
public class Rules_Creditor_Party_Validate extends BaseClass {
	...
	public static void Rule_Creditor_Party_Validate(String TSID, String dealId, String participant1) throws Exception {
