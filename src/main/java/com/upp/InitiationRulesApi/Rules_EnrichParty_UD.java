...
public class Rules_EnrichParty_UD extends BaseClass {
	...
	public static void Rule_EnrichParty_UD(String TSID, String dealId, String participant1) throws Exception {
		...
		Response res = given().header("Content-Type", "application/json")
				...
				.body(Payload.rule_EnrichParty_UD(TSID, dealId, participant1)).when()
