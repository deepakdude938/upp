...
public class Rules_EnrichParty_UD1 extends BaseClass {
	...
	public static void Rule_EnrichParty_UD1(String TSID, String dealId, String participant1) throws Exception {
		...
		Response res = given().header("Content-Type", "application/json")
				...
				.body(Payload.rule_EnrichParty_UD1(TSID, dealId, participant1)).when()
		...
		if (res.getStatusCode() == 200) {
			...
			offerTo1 = js.getString("offerTo");
			Assert.assertEquals(offerTo1, "TRANSACTIONVERIFIER");
		}
	}
}
