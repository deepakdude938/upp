...
public class Payload extends BaseClass {
	...
	public static String Rule_OBOParticipant_OBO_Info_Not_Null(String dealId, String TSID) throws IOException, Exception {
		externalData = new ExcelReader();
		String payLoadString = externalData.getFieldData(TSID, "Initiation Rules", "Payload");
	...
	public static String rule_EnrichParty_UD1(String TSID, String dealId, String accountNo) throws IOException, Exception {
		externalData = new ExcelReader();
		String payLoadString = externalData.getFieldData(TSID, "Initiation Rules", "Payload");
	...
	public static String rule_EnrichParty_UD(String TSID, String dealId, String accountNo) throws IOException, Exception {
		externalData = new ExcelReader();
		String payLoadString = externalData.getFieldData(TSID, "Initiation Rules", "Payload");
	...
	public static String Rule_OBOPartyResponsibility_PartyId_DealRefId(String dealId, String TSID) throws IOException, Exception {
		externalData = new ExcelReader();
		String payLoadString = externalData.getFieldData(TSID, "Initiation Rules", "Payload");
